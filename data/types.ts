...
export type OperationalCase = { id: string; modulo: string; categoria: string; titulo: string; palabras_clave: string[]; que_comprobar: string[]; resultado: string; norma: string; articulo: string; norma_infringida?: string | null; articulo_infringido?: string | null; tipificacion_norma?: string | null; tipificacion_articulo?: string | null; tipificacion_etiqueta?: string | null; textoDenuncia?: string | null; es_infraccion_autonoma?: boolean; inmovilizacion?: ImmobilizationStatus | null; motivo_inmovilizacion?: string | null; actuacion_breve?: string[]; codificado?: string | null; calificacion?: string | null; rango_min?: number | null; rango_max?: number | null; importe_fijo?: number | null; importe_reducido?: number | null; responsable?: string | null; medidas?: string[]; actuacion: string[]; competencia_denuncia: string; competencia_instruye?: string | null; competencia_resuelve: string; destino_diligencias_penales?: string | null; penal_article_id?: string | null; advertencias: string[]; alerta_penal: boolean; referencia_penal?: string | null; regla_transversal?: string | null; fuentes: string[]; fichas_juridicas: string[]; estado: CaseStatus; datos_adicionales?: AdditionalCaseData };
